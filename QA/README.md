...
7. [Software Testing Life Cycle](#software-testing-life-cycle)
   ...
   - [Example: Defect Report (Bug Report)](#example-defect-report-bug-report)
   - [Example: Test Summary Report](#example-test-summary-report)
...
- [Example: Test Case and Scenarios](./assets/examples/qaBasics/testCaseAndScenarios/README.md)
...
## Example: Defect Report (Bug Report)
...
- [Example: Test Summary Report](./assets/examples/softwareTestingLifeCycle/testSummaryReport.md)
